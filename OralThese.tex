...
{\usebackgroundtemplate{\tikz\node[opacity=0.1]{\includegraphics[width=\paperwidth]{Figures/Flowers.jpeg}};}
\begin{frame}
  \maketitle
\end{frame}
}
...
\Wider{ 
  ...
  \column{0.6\textwidth}
    ...
    \begin{itemize}
      \item Mesure de $H_0$ en utilisant des observations rayon X d'amas de galaxies et l'effet de Sunyaev-Zel'dovich
      \item Analyse de données, travail théorique pour interprétation
    \end{itemize}
  \column{0.5\textwidth}
    \begin{figure}[hbtp]
      \centering
...
\begin{columns}
  \column{0.5\textwidth}
  \begin{itemize}
    \item Construction + évaluation d'un modèle simple, comparaison avec CRM
  ...
  \begin{figure}[hbtp]
    \centering
    \includegraphics[width=5.9cm]{Figures/meanRHpvsRHa.png}
  \end{figure}
\end{columns}
\vspace{-0.4cm}
\begin{figure}[hbtp]
  \centering
  \includegraphics[width=10.5cm]{Figures/AllComps.png}
\end{figure}
}
\end{frame}
