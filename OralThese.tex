...
\begin{columns}
  ...
  \begin{figure}[hbtp]
    \centering
    \includegraphics[width=5.1cm]{/Users/felixlangot/Stage/GitRepos/Codes/Figs/meanRHpvsRHa.png}
  \end{figure}
\end{columns}
\vspace{-0.2cm}
\begin{figure}[hbtp]
  \centering
  \includegraphics[width=9.2cm]{/Users/felixlangot/Stage/GitRepos/Codes/Figs/AllComps.png}
\end{figure}
}
\end{frame}
